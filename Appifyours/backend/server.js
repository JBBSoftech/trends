...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/trends_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '690b4ead863124637c55f506',
      shopName: 'Trends',
...
app.listen(PORT, () => {
  console.log(`Trends Backend Server running on port ${PORT}`);
});
